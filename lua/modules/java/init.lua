...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
if not require("retrofox.module").enabled("java") then
    return {}
end
...
local function setup_jdtls(bufnr)
    ...
    local config = {
        ...
        on_attach = function(_, attached_bufnr)
            ...
            map("n", "<leader>jev", function()
                jdtls.extract_variable()
            end, "[J]ava [E]xtract [V]ariable")
            map("v", "<leader>jev", function()
                jdtls.extract_variable(true)
            end, "[J]ava [E]xtract [V]ariable")
            map("n", "<leader>jec", function()
                jdtls.extract_constant()
            end, "[J]ava [E]xtract [C]onstant")
            map("v", "<leader>jec", function()
                jdtls.extract_constant(true)
            end, "[J]ava [E]xtract [C]onstant")
            map("v", "<leader>jem", function()
                jdtls.extract_method(true)
            end, "[J]ava [E]xtract [M]ethod")
            map("n", "<leader>jsi", function()
                jdtls.super_implementation()
            end, "[J]ava [S]uper [I]mplementation")
